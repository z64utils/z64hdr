...
#define gsSPClipRatio(r)                              \
	gsMoveWd(G_MW_CLIP, G_MWO_CLIP_RNX, (u16)(r)),    \
	gsMoveWd(G_MW_CLIP, G_MWO_CLIP_RNY, (u16)(r)),    \
	gsMoveWd(G_MW_CLIP, G_MWO_CLIP_RPX, (u16) - (r)), \
	gsMoveWd(G_MW_CLIP, G_MWO_CLIP_RPY, (u16) - (r))
